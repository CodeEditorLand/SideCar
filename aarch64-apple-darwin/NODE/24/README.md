...
The Node.js project uses an [open governance model](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/GOVERNANCE.md). The
[OpenJS Foundation][] provides support for the project.

Contributors are expected to act in a collaborative manner to move
the project forward. We encourage the constructive exchange of contrary
opinions and compromise. The [TSC](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/GOVERNANCE.md#technical-steering-committee)
...
[instructions for getting support](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/.github/SUPPORT.md).
...
See [BUILDING.md](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/BUILDING.md) for instructions on how to build Node.js from
source and a list of supported platforms.

## Security

For information on reporting security vulnerabilities in Node.js, see
[SECURITY.md](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/SECURITY.md).
...
[GOVERNANCE.md](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/GOVERNANCE.md).
...
Collaborators follow the [Collaborator Guide](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/doc/contributing/collaborator-guide.md) in
...
Triagers follow the [Triage Guide](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/doc/contributing/issues.md#triaging-a-bug-report) when
...
[security release process](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/24/doc/contributing/security-release-process.md).
