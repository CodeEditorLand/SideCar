...
The Node.js project uses an [open governance model](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/16/GOVERNANCE.md). The
...
[instructions for getting support](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/16/.github/SUPPORT.md).
...
See [BUILDING.md](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/16/BUILDING.md) for instructions on how to build Node.js from
source and a list of supported platforms.

## Security

For information on reporting security vulnerabilities in Node.js, see
[SECURITY.md](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/16/SECURITY.md).
...
[GOVERNANCE.md](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/16/GOVERNANCE.md).
...
[Collaborator Guide](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/16/doc/contributing/collaborator-guide.md) in maintaining
the Node.js project.
...
[security release process](https://github.com/CodeEditorLand/SideCar/tree/main/aarch64-apple-darwin/NODE/16/doc/contributing/security-release-process.md).
