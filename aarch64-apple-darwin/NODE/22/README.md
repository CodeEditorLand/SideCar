...
The Node.js project uses an [open governance model](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/GOVERNANCE.md). The
...
compromise. The [TSC](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/GOVERNANCE.md#technical-steering-committee) reserves the
...
[instructions for getting support](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/.github/SUPPORT.md).
...
See [BUILDING.md](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/BUILDING.md) for instructions on how to build Node.js from
source and a list of supported platforms.

## Security

For information on reporting security vulnerabilities in Node.js, see
[SECURITY.md](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/SECURITY.md).
...
[GOVERNANCE.md](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/GOVERNANCE.md).
...
[Collaborator Guide](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/doc/contributing/collaborator-guide.md) in maintaining
the Node.js project.
...
Triagers follow the
[Triage Guide](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/doc/contributing/issues.md#triaging-a-bug-report) when
...
[security release process](https://github.com/CodeEditorLand/SideCar/tree/Current/aarch64-apple-darwin/NODE/22/doc/contributing/security-release-process.md).
